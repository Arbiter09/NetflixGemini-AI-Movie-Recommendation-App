...
const VideoTitle = ({ title, description }) => {
  return (
    <div className="pt-[20%] px-12 text-white w-screen aspect-video absolute bg-gradient-to-r from-black">
      <h1 className="text-6xl font-bold mb-6 ">{title}</h1>
      <p className="text-xl w-1/3 text-gray-300 font-light">{description}</p>
